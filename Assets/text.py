...
How to play:
    ...
    The color of a letter will change to show how close your guess was
    If a letter turns\033[032m green\033[0m, the letter is in the word, and it is in the correct spot
    If a letter turns\033[033m yellow\033[0m, the letter is in the word, but it is not in the correct spot
    If a letter turns white, the letter is not in the word
    If you fail to guess the word in 6 attempts, you will need to defeat an enemy in battle to try again
